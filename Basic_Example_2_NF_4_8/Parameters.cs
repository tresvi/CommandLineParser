...
namespace Basic_Example_2_NF_4_8
{
    public class Parameters
    {
        ...
        [Option("fechaproceso", 'f', true, "Fecha en la cual se realiza el procesamiento.")]
        public DateTime FechaProceso { get; set; }

        [Flag("notificarpormail", 'n', "Indica si se debe notificar por mail el resultado del proceso.")]
        public bool NotificarPorMail { get; set; }

        [Option("reintentos", 'r', true, "Fecha en la cual se realiza el procesamiento.")]
